...
이 사이트에는 Google Ads 같은 광고가 없고, 확장 프로그램에도 유료 버전이 없습니다. API 중계 서비스의 후원도 받지 않았습니다. 사용자 데이터를 어떻게 다루는지 확인할 수 없기 때문입니다. 마음은 단순합니다. 제가 매일 쓰고 친구에게도 추천하고 싶은 도구를 만드는 것 —— 소란스러운 시대 속에서도 진심을 잃지 않으면서요.
