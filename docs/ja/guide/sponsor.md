...
このサイトには Google Ads などの広告はなく、拡張機能にも有料版はありません。API 中継サービスからの資金提供も断っています。ユーザーデータの扱い方を確認できないからです。想いはシンプルで、自分が毎日使い、友人にも勧めたくなるようなツールを作ること —— 騒がしい時代の中でも、誠実さを失わずにいたいのです。
